...
//Pokemons
class MyPokemons extends Pokemon {
    private final String Name;

    public MyPokemons(String Name, int Level) {
        super(Name, Level);
        this.Name = Name;
    }
...
//Гиратина
class pok_Giratina extends MyPokemons {
...
//Карванха
class pok_Carvanha extends MyPokemons {
...
//Поригон
class pok_Porygon extends MyPokemons {
